...
require 'src/states/entity/Bzt/BztChasingState'
require 'src/states/entity/Bzt/BztIdleState'
require 'src/states/entity/Bzt/BztMovingState'

require 'src/states/entity/fireballGo'
...
gFrames = {
    ...
    ['poles'] = GenerateQuads(gTextures['poles'], 16, 50),
